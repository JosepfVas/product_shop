...
class Subcategory(models.Model):
    """ Класс подкатегорий """
    category = models.ForeignKey(Category, on_delete=models.CASCADE, verbose_name='ссылка на категорию')
    name = models.CharField(max_length=200, verbose_name='название подкатегории')
    slug = models.SlugField(unique=True)
    image = models.ImageField(upload_to='subcategories/', **NULLABLE, verbose_name='изображение')
...
class Product(models.Model):
    """ Класс продуктов """
    subcategory = models.ForeignKey(Subcategory, on_delete=models.CASCADE, verbose_name='ссылка на подкатегорию')
    ...
    image_medium = models.ImageField(upload_to='products/medium/', **NULLABLE, verbose_name='среднее изображение '
                                                                                            'продукта')
    image_large = models.ImageField(upload_to='products/large/', **NULLABLE, verbose_name='большое изображение '
                                                                                          'продукта')
