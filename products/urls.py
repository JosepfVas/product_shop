...
from products.views import CategoryListAPIView, SubcategoryListAPIView, ProductListAPIView, ProductRetrieveAPIView
...
urlpatterns = [
    ...
    # Subcategory CRUD
    path('subcategory_list/', SubcategoryListAPIView.as_view(), name='subcategory_list'),
